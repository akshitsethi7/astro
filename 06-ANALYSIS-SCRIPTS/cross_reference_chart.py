...
SEARCH_PATTERNS = {
    ...
    "career_10th": {
        ...
        "patterns": [
            ...
            r"(?i)venus.*career",
            r"(?i)career.*venus",
            r"(?i)technology.*career.*astrology",
        ]
    },
    "health": {
        "description": "Health rules for Leo ascendant",
        "patterns": [
...
TOPIC_FILTER_MAP = {
    "marriage": ["marriage_general", "marriage_timing", "spouse_nature", "navamsa_marriage", "saturn_7th_specific"],
    "jaimini": ["jaimini"],
